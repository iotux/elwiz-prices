...
// All config loading should go through utils/configLoader.js
function loadYaml(configPath) {
  console.warn('WARNING: loadYaml from util.js is deprecated. Use ConfigLoader instead.');
  try {
...
module.exports = {
  ...
  getMacAddress,
  getCurrencySymbol,
  // Note: loadYaml is kept for compatibility but should not be used
  // All config loading should go through utils/configLoader.js
  loadYaml
};
